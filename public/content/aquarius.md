...
- **Metamagic:** Modify spells in various ways using sorcery points (level 3, choose 2 options)
...
- **Divine Soul:** Access to cleric spells, favored by the gods
- **Shadow Magic:** Summon hound of ill omen, darkness powers
- **Aberrant Mind:** Telepathy, psionic spells, psychic powers
...
**Elemental Flavor:** Lightning crackles between your fingers, wind swirls when you cast, storms follow your emotional state.

**Recommended Spells:** Thunderwave, Gust of Wind, Fly, Lightning Bolt, Storm Sphere, Chain Lightning, Whirlwind
...
- **Heightened Spell:** Give one target disadvantage on save
- **Quickened Spell:** Cast spell as bonus action
- **Subtle Spell:** Cast without verbal or somatic components
- **Twinned Spell:** Target two creatures instead of one
- **Transmuted Spell:** Change spell's damage type
...
- **Nova Damage:** Quickened Spell for bonus action spell + regular action spell

## Strengths

Metamagic makes spells more powerful and flexible, Charisma-based for social situations, Font of Magic adds resource management, spontaneous casting (no preparation)

## Weaknesses

Lowest hit points, no armor proficiency, fewest spells known of all casters, sorcery points are limited, metamagic costs add up quickly
