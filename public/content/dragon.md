...
- Unmatched magical versatility
- Devastating offensive capabilities
- Intimidation and crowd control

## Weaknesses

- Physically vulnerable without transformation
- High resource consumption
- Arrogance can lead to tactical errors

## Compatibility

Naturally leads any group. Synergizes with support classes who can enable extended casting. Clashes with other dominant personalities.
