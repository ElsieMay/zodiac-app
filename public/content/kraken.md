...
- Tentacle Strike: Multiple grasping attacks with extended reach
- Crushing Depths: Create zones of intense pressure
- Storm Summoning: Weather control and water manipulation

## Strengths

- Exceptional area control
- Multiple simultaneous attacks
- Dominates aquatic environments

## Weaknesses

- Less effective in arid environments
- Vulnerable to lightning/electricity
- Large size makes evasion difficult

## Compatibility

Supreme in naval or coastal combat. Works well with other area control specialists. Struggles in desert or confined spaces.
