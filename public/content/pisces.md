...
- **Unarmored Movement:** Movement speed increases (level 2, +10 ft., increases with level)
- **Deflect Missiles:** Catch and throw back projectiles (level 3)
- **Slow Fall:** Reduce falling damage (level 4)
- **Extra Attack:** Attack twice per action (level 5)
- **Stunning Strike:** Spend ki to potentially stun on hit (level 5)
...
**Elemental Flavor:** Your movements are fluid like water, your strikes flow seamlessly, your defense adapts like water finding its level.

**Recommended Approach:** Describe Flurry of Blows as flowing strikes, Patient Defense as water's yielding nature, Step of the Wind as riding waves.
...
High mobility, no equipment needed, stunning strike is powerful, can catch arrows, eventually immune to poison and disease, abundant reactions

## Weaknesses

MAD (multiple ability dependent - needs DEX, WIS, CON), ki points are limited resource, low AC early levels, vulnerable to AoE saves besides DEX
