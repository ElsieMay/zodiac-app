...
- **Cunning Action:** Bonus action to Dash, Disengage, or Hide (level 2)
- **Uncanny Dodge:** Use reaction to halve damage from an attack (level 5)
...
- **Inquisitive:** Investigation expert, insightful fighting, unerring eye
- **Mastermind:** Help as bonus action, master of tactics and disguise
- **Scout:** Skirmisher mobility, survivalist, ambush master
- **Swashbuckler:** Fancy Footwork, Rakish Audacity, use CHA for initiative
- **Phantom:** Death-themed abilities, tokens of the departed
...
**Elemental Flavor:** Your attacks are fluid and adaptive, you move like water through shadows, your presence is as deep and mysterious as the ocean.

**Recommended Poison/Water Flavor:** Describe sneak attacks as drowning strikes, use water-based poisons, move in mist-like stealth.
...
Highest single-target damage with Sneak Attack, most skill proficiencies, Expertise makes you the best at chosen skills, excellent mobility with Cunning Action

## Weaknesses

Light armor only, requires positioning for Sneak Attack, lower HP pool, depends heavily on DEX, one attack per turn
