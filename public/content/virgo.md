...
- **Destroy Undead:** Channel Divinity to instantly destroy low CR undead
...
- **Nature Domain:** Druid spells, befriend animals, heavy armor
- **Tempest Domain:** Lightning and thunder damage, destructive wrath, heavy armor
- **Trickery Domain:** Stealth and deception, invoke duplicity, poison
- **War Domain:** Bonus attacks, martial prowess, heavy armor
- **Death Domain:** Necrotic damage, raise undead
- **Forge Domain:** Craft items, fire resistance, heavy armor
- **Grave Domain:** Prevent death, cancel crits, necrotic/radiant damage
- **Order Domain:** Command allies, enchantment spells, heavy armor
- **Peace Domain:** Protective bond between allies, advantage sharing
...
**Elemental Flavor:** Your healing manifests as natural growth, your blessings solidify like stone, your spells feel rooted and stable.
...
Best healing in game, prepare any cleric spell, heavy armor option via domains, versatile spell list, Channel Divinity adds utility

## Weaknesses

Dependent on Wisdom for effectiveness, medium HP pool, domains lock in playstyle early, concentration-dependent
